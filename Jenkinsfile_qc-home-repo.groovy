pipeline {
        ...
        stage('Deploy QC-Home-Repo Bundle') {
            steps {
                script {
                    ...
                    // qc-home-repo의 루트 디렉토리에서 Dockerfile이 존재하므로 dir() 필요 없음
    ...
    post {
        ...
        failure {
            echo "CI/CD Pipeline for qc-home-repo failed."
        }
        success {
            echo "CI/CD Pipeline for qc-home-repo finished successfully."
        }
    }
}